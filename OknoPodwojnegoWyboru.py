...
class OknoPodwojnegoWyboru():
    def __init__(self,main,text,akcjaNegatywna,akcjapozytywna,textPozytywny,textNegatyny):
        self.main=main
        self.text =text
        self.akcjanegatywna = akcjaNegatywna
        self.akcjapozytywna=akcjapozytywna
        self.textPozytywny = textPozytywny
        self.textNegatywny=textNegatyny
        ...
        self.PrzyciskNie = Przycisk(self.main,self.textNegatywny,(80,20),(240,360),(255,0,0),20,self.Nie,True,(0,0,0),(200,0,0))
        self.PrzyciskTak = Przycisk(self.main, self.textPozytywny, (80, 20), (480, 360), (0, 255, 0), 20, self.Tak, True,(0, 0, 0), (0, 200, 0))
    def wys(self):
